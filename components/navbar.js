...
export default function NavBar() {
  return (
    ...
    >
      <Navbar.Brand href="/">
        <img src="/assets/img/logo.svg" alt="ICSSC Logo" height="45px" />
      </Navbar.Brand>
      ...
      <Navbar.Collapse id="collapsable-navbar">
        <Nav className="ml-auto mt2 mt-lg-0">
          ...
          <NavDropdown
            title="Election"
            id="nav-dropdown"
            className="mr-4 mb-2 mb-lg-0 nav-unique-element"
          >
            <NavDropdown.Item href="/election">
              About the Election
            </NavDropdown.Item>
